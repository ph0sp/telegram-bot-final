...
@app.route('/')
def home():
    return "🤖 Бот работает корректно! Статус: ONLINE"
...
def run_bot():
    ...
    try:
        # Создание Application с правильной конфигурацией
        ...
        # Настраиваем планировщик для ежедневных уведомлений (только если JobQueue доступен)
        if application.job_queue:
            ...
            logger.warning("⚠️ JobQueue не доступен. Ежедневные уведомления отключены.")
...
if __name__ == '__main__':
    ...
    # Запускаем Flask сервер для Render.com
