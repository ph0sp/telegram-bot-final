...
if GOOGLE_SHEETS_ID and GOOGLE_CREDENTIALS_JSON:
    try:
        ...
        if os.path.exists(creds_file_path):
            ...
            logger.warning(f"⚠️ Файл {GOOGLE_CREDENTIALS_JSON} не найден")
...
if DATABASE_URL:
    try:
        ...
        logger.info("✅ PostgreSQL подключение доступно")
    except Exception as e:
        logger.error(f"❌ Ошибка подключения к PostgreSQL: {e}")
else:
    logger.warning("⚠️ DATABASE_URL не указан в .env")
